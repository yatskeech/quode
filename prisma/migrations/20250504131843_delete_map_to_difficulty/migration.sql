/*
  ...
  - The values [Лёгкая,Средняя,Сложная] on the enum `Difficulty` will be removed. If these variants are still used in the database, this will fail.
...
ALTER TABLE "Problem" ALTER COLUMN "difficulty" SET DEFAULT 'medium';
COMMIT;
